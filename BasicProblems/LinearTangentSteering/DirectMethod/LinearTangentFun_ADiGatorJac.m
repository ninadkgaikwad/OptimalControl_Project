...
function C = LinearTangentFun_ADiGatorJac(z)
global ADiGator_LinearTangentFun_ADiGatorJac
if isempty(ADiGator_LinearTangentFun_ADiGatorJac); ADiGator_LoadData(); end
Gator1Data = ADiGator_LinearTangentFun_ADiGatorJac.LinearTangentFun_ADiGatorJac.Gator1Data;
...
cada1f1 = cos(u.f);
cada1f2dz0 = a.*cada1f1dz0;
cada1f2 = a*cada1f1;
cada1f3dz0 = cos(u.f(:)).*u.dz0;
cada1f3 = sin(u.f);
cada1f4dz0 = a.*cada1f3dz0;
cada1f4 = a*cada1f3;
cada1td1 = zeros(480,1);
cada1td1(Gator1Data.Index8) = x3.dz0;
cada1td1(Gator1Data.Index9) = x4.dz0;
cada1td1(Gator1Data.Index10) = cada1f2dz0;
cada1td1(Gator1Data.Index11) = cada1f4dz0;
diffeqRHS.dz0 = cada1td1;
diffeqRHS.f = [x3.f x4.f cada1f2 cada1f4];
%User Line: diffeqRHS = [x3, x4, a*cos(u), a*sin(u)];
%User Line: %-----------------------------------------------------------------%
...
%User Line: %-----------------------------------------------------------------%
cada1td1 = sparse(Gator1Data.Index12,Gator1Data.Index13,statePlusEnd.dz0,121,484);
cada1td1 = D*cada1td1;
cada1td1 = cada1td1(:);
diffeqLHS.dz0 = full(cada1td1(Gator1Data.Index14));
...
cada1f1dz0 = cada1td1;
cada1f1 = tf.f - t0.f;
cada1tempdz0 = cada1f1dz0(Gator1Data.Index15);
cada1tf1 = diffeqRHS.f(Gator1Data.Index16);
cada1td1 = zeros(1440,1);
cada1td1(Gator1Data.Index17) = cada1tf1(:).*cada1tempdz0;
cada1td1(Gator1Data.Index18) = cada1td1(Gator1Data.Index18) + cada1f1.*diffeqRHS.dz0;
cada1f2dz0 = cada1td1;
cada1f2 = cada1f1*diffeqRHS.f;
cada1f3dz0 = cada1f2dz0./2;
cada1f3 = cada1f2/2;
cada1td1 = zeros(3840,1);
cada1td1(Gator1Data.Index19) = diffeqLHS.dz0;
cada1td1(Gator1Data.Index20) = cada1td1(Gator1Data.Index20) + -cada1f3dz0;
...
%User Line: J   = tf;
cada1td1 = zeros(3841,1);
cada1td1(3361) = J.dz0;
cada1td1(Gator1Data.Index21) = defects.dz0;
C.dz0 = cada1td1;
C.f = [J.f;defects.f];
%User Line: C = [J; defects];
C.dz0_size = [481,606];
C.dz0_location = Gator1Data.Index22;
end


function ADiGator_LoadData()
global ADiGator_LinearTangentFun_ADiGatorJac
ADiGator_LinearTangentFun_ADiGatorJac = load('LinearTangentFun_ADiGatorJac.mat');
return
end