...
function obj = LinearTangentObj_ADiGatorJac(z)
global ADiGator_LinearTangentObj_ADiGatorJac
if isempty(ADiGator_LinearTangentObj_ADiGatorJac); ADiGator_LoadData(); end
Gator1Data = ADiGator_LinearTangentObj_ADiGatorJac.LinearTangentObj_ADiGatorJac.Gator1Data;
...
%User Line: obj = J;
obj.dz0_size = 606;
obj.dz0_location = Gator1Data.Index8;
end


function ADiGator_LoadData()
global ADiGator_LinearTangentObj_ADiGatorJac
ADiGator_LinearTangentObj_ADiGatorJac = load('LinearTangentObj_ADiGatorJac.mat');
return
end