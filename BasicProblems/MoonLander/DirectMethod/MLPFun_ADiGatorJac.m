...
function C = MLPFun_ADiGatorJac(z)
global ADiGator_MLPFun_ADiGatorJac
if isempty(ADiGator_MLPFun_ADiGatorJac); ADiGator_LoadData(); end
Gator1Data = ADiGator_MLPFun_ADiGatorJac.MLPFun_ADiGatorJac.Gator1Data;
...
cada1td1(Gator1Data.Index7) = cada1f2dz0;
diffeqRHS.dz0 = cada1td1;
diffeqRHS.f = [v.f cada1f2];
%User Line: diffeqRHS = [v, -g + u];
%User Line: %-----------------------------------------------------------------%
...
global ADiGator_MLPFun_ADiGatorJac
ADiGator_MLPFun_ADiGatorJac = load('MLPFun_ADiGatorJac.mat');
return
end