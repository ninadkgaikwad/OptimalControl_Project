...
-Changed a ‘printf’ to ‘fprintf’ in adigatorGenFiles4Ipopt.m
-Added parentheses when printing out negative numbers to avoid order of operation issues.
-Added a dummy ‘cadaCheckForDerivs’ routine that will get called for non-overloaded variables and always return false.
V 1.4 4/22/17
